...
{
    const footerPages = `<footer class="bg-dark text-center text-white">
    <!-- Grid container -->
        ...
        <div class="row">  
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled mb-0" style="text-align: center;">
              <li>
                <a href="../Index.html" class="styleLink">Inicio</a>
              </li>
              <li>
                <a href="SobreNosotros.html" class="styleLink">Sobre Nosotros</a>
              </li>
              <li>
                <a href="Contactanos.html" class="styleLink">Contáctanos</a>
              </li>
              <li>
                <a href="Tematica.html" class="styleLink">Temática del PTC</a>
              </li>
              <li>
                <a href="Licencias.html" class="styleLink">Licencias del sitio web</a>
              </li>
            </ul>
          </div>
          <!--Grid column-->
